...
<body>
	...
	<h1>Results Per Year</h1>
	
	
			
	<h2>Return On Investment</h2>
	<span class="resulttitle">Estimated Time Till ROI :</span>
	<span class="result"><%= resultsbean.ROI() %></span>
	<br />
	<span class="resulttitle">Expected Daily Output :</span>
	<span class="result"><%= resultsbean.dailyOutput() %></span>
	<br />
	<span class="resulttitle">System Cost :</span>
	<span class="result"><%= resultsbean.cost() %></span>
	<br />
	<span class="resulttitle">Savings (1st month) :</span>
	<span class="result"><%= resultsbean.savingsFirstMonth() %></span>
	<br />
	<span class="resulttitle">Savings (Lifespan) :</span>
	<span class="result"><%= resultsbean.savingsLifespan() %></span>
	<br />
